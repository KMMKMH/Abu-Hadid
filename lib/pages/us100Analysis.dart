...
class US100Analysis extends StatefulWidget {
  final Socket socket;
  ...
  @override
  State<US100Analysis> createState() => _US100AnalysisState();
}

class _US100AnalysisState extends State<US100Analysis> {
  ...
  void sendSignal() async {
    if(_AnalysisController.text.isNotEmpty) {
      await _chatService.sendSignalToUS100(
          widget.positivity,
            ...
            Row(
              ...
              children: [
                ...
                FloatingActionButton(
                  onPressed: () {
                    sendSignal();
                    widget.socket.SendNotifi("US100 news");
                  },
                  mini: true,
                  child: Icon(
                    Icons.add,
