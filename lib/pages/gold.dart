...
import 'package:abu_hadid_app/pages/goldSignal.dart';
...
class _GoldState extends State<Gold> {
  ...
  Widget _buildSignalList() {
    return StreamBuilder(stream: _chatService.getSignalsFromGold(), builder: (context, snapshot) {
...
${data['analysis']}
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Row(
                              ...
                              children: [
                                ...
                                TextButton(
                                    onPressed: () {
                                      FirebaseFirestore.instance.collection('signal_room').doc('gold_room').collection('signals').doc(document.id).delete();
                                      ScaffoldMessenger.of(context).hideCurrentSnackBar();
                                    },
                                    child: Text(
                                      'Delete',
  ...
  Widget _buildSignalsAdder(bool admin) {
    return FloatingActionButton(
        onPressed: () {
          if (admin) {
            Navigator.push(context, MaterialPageRoute(builder: (context) => GoldSignal(
