import 'package:abu_hadid_app/pages/goldAnalysis.dart';
import 'package:flutter/material.dart';
import '../chat/chat_service.dart';
import '../classes/Socket.dart';
import '../classes/widgets.dart';

class GoldSignal extends StatefulWidget {
  final Socket socket;
  const GoldSignal({
    super.key,
  ...
  @override
  State<GoldSignal> createState() => _GoldSignalState();
}

class _GoldSignalState extends State<GoldSignal> {
