...
class US30Analysis extends StatefulWidget {
  final Socket socket;
  ...
  @override
  State<US30Analysis> createState() => _US30AnalysisState();
}

class _US30AnalysisState extends State<US30Analysis> {
  ...
  void sendSignal() async {
    if(_AnalysisController.text.isNotEmpty) {
      await _chatService.sendSignalToUS30(
          widget.positivity,
            ...
            Row(
              ...
              children: [
                ...
                FloatingActionButton(
                  onPressed: () {
                    sendSignal();
                    widget.socket.SendNotifi("US30 news");
                  },
                  mini: true,
                  child: Icon(
                    Icons.add,
